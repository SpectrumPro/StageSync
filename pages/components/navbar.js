...
export default function Navbar() {
    ...
    var items = [
        ...
        { text: "On Screen Graphics", link: "", imageLink: "#" },
    ]
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl" id="apps-dropdown">
                        ...
                        <div class="grid grid-cols-3 gap-4 p-4">
                            {items.map((item) => (
                                <a href={item.link} key={item.id} class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                                    {/* <Image src={item.imageLink} alt="" width={10} height={10}/> */}
                    ...
                    <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                        ...
                        <img class="w-8 h-8 rounded-full" src="/blank-profile-picture-973460_640.webp" alt="user photo" />
                    </button>
